    ...
    if (tokenForm) {
      ...
      tokenForm.addEventListener("change", function () {
        ...
        store.updateProject(function (project) {
          ...
          face.backgroundColor = helpers.readColorFormValue(formData, "backgroundColor", face.backgroundColor);
          ...
          face.border.color = helpers.readColorFormValue(formData, "borderColor", face.border.color);
    ...
    if (textComponentForm) {
      ...
      textComponentForm.addEventListener("change", function () {
        ...
        store.updateProject(function (project) {
          ...
          component.color = helpers.readColorFormValue(formData, "color", component.color);
          ...
          component.textBorder.color = helpers.readColorFormValue(formData, "textBorderColor", component.textBorder.color);
