(function (global, factory) {
...
})(typeof globalThis !== "undefined" ? globalThis : window, function (Schema, State, Sequences, Utils, Tokens, Renderer, Print, Ui) {
  ...
  function render(appElement, store) {
    ...
    appElement.innerHTML = [
      ...
      "  </nav>",
      renderPanel("settings", activeTab, activeTab === "settings" ? renderSettingsPanel(state) : ""),
      renderPanel("designer", activeTab, activeTab === "designer" ? renderDesignerPanel(state) : ""),
      renderPanel("print", activeTab, activeTab === "print" ? renderPrintPanel(state) : ""),
      "</main>"
    ].join("");
  ...
  function bindDesignerEvents(appElement, store) {
    ...
    if (tokenForm) {
      ...
      bindBackgroundUploadControls(tokenForm, {
        uploadAction: "upload-token-background",
        removeAction: "remove-token-background",
  ...
  function bindBackgroundUploadControls(container, config) {
    var uploadButton = container.querySelector('[data-action="' + config.uploadAction + '"]');
    var removeButton = container.querySelector('[data-action="' + config.removeAction + '"]');
